...
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '9779579170316', 3, 1, 1, 'FERNANDO', 'ISMAEL', 'BARRIOS', 'CASTILLA', NULL, '14-02-1980');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '4510929470401', 2, 2, 2, 'ANA', 'GABRIELA', 'CUXUM', 'HERNANDEZ', 'MENDEZ', '14-09-1978');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '2609695100405', 3, 1, 1, 'DANIEL', 'HUMBERTO', 'MOTTA', 'CASTILLO', NULL, '20-11-2001');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
...
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6239208480303', 3, 1, 1, 'JEREMIAS', NULL, 'CARBAJO', 'OSORIO', NULL, '21-04-1999');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
...
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '9271936121229', 3, 2, 2, 'VICTORIA', 'MARIANELA', 'MORALES', 'LINARES', NULL, '24-06-1999');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
...
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '5466238372011', 3, 1, 1, 'JUAN', 'SEBASTIAN', 'PRADO', 'MORALES', NULL, '13-06-1973');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '3288702072012', 2, 2, 2, 'ISABEL', 'LISETH', 'RODRIGUEZ', 'MENDOZA', NULL, '04-04-1999');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '4891356650101', 1, 1, 1, 'DOUGLAS', 'SAMUEL', 'GARCIA', 'SOTO', NULL, '09-12-2001');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '5241332192001', 3, 2, 2, 'ANA', 'JIMENA', 'ENRIQUEZ', 'CASTILLA', NULL, '20-03-2003');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2,APELLIDO_1, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
