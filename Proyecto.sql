...
insert into TIPO_IDENTIFICACION (COD_IDENTIFICACION, TIPO_IDENTIFICACION) values (SQC_TIPO_IDENTICACION.Nextval, 'LICENCICA DE CONDUCIR');
insert into TIPO_IDENTIFICACION (COD_IDENTIFICACION, TIPO_IDENTIFICACION) values (SQC_TIPO_IDENTICACION.Nextval, 'PASAPORTE');
insert into TIPO_IDENTIFICACION (COD_IDENTIFICACION, TIPO_IDENTIFICACION) values (SQC_TIPO_IDENTICACION.Nextval, 'EXTRANJERO');
...
values (SQC_PERSONA.Nextval, '5901782430101', 2, 1, 1, 'ALEX', 'JOEL', 'HERNANDEZ', 'LOPEZ', NULL, '07-21-1992');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '3992782680102', 1, 1, 1, 'LUIS', 'ALEJANDRO', 'CORONADO', 'CORONADO', NULL, '08-15-1963');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '7010101830202', 1, 2, 2, 'ANA', 'SOFIA', 'FUENTES', 'ALVAREZ', 'CARRILLO', '10-31-1977');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '3231213560201', 2, 1, 1, 'BARTOLOME', 'ISAI', 'GONZALES', 'LOPEZ', NULL, '08-16-1978');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6261473190117', 1, 2, 2, 'CARLOTA', 'ALEJANDRA', 'GONZALES', 'GUTIERREZ', NULL, '04-30-2000');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '3485256910101', 1, 2, 3, 'DINA', ' MARIA', 'CASTILLO', 'ALVAREZ', NULL, '03-01-2001');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '8255901470208', 2, 1, 3, 'LUIS', 'ESTEBAN', 'PEREZ', 'LOPEZ', NULL, '01-25-1994');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '9779579170316', 1, 1, 1, 'FERNANDO', 'ISMAEL', 'BARRIOS', 'CASTILLA', NULL, '02-14-1980');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '4510929470401', 2, 2, 2, 'ANA', 'GABRIELA', 'CUXUM', 'HERNANDEZ', 'MENDEZ', '09-14-1978');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '2609695100405', 2, 1, 1, 'DANIEL', 'HUMBERTO', 'MOTTA', 'CASTILLO', NULL, '11-20-2001');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '2730002000706', 1, 1, 1, 'PAULINO', 'DANIEL', 'JIMENEZ', 'SAMAYOA', NULL, '12-03-2003');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '8206640010707', 2, 2, 3, 'ANA', 'NEREIDA', 'LUCERO', 'CASTILLO', NULL, '12-07-2000');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6915570040711', 1, 1, 3, 'LUIS', 'GONZALO', 'PAREDES', 'CAMPOS', NULL, '05-26-1985');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6239208480303', 1, 1, 1, 'JEREMIAS', NULL, 'CARBAJO', 'OSORIO', NULL, '04-21-1999');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '4891356651229', 2, 1, 1, 'JOSE', 'MARIO', 'HERNANDEZ', 'OLIVARES', NULL, '09-12-1990');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '4114983741228', 1, 2, 2, 'JEIMY', 'VANESA', 'COLINDRES', 'HURTADO', 'OLIVARES', '07-17-1991');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6630258991310', 2, 1, 1, 'ARTURO', 'VICENTE', 'RUIZ', 'MENDOZA', NULL, '11-03-1983');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6560079711311', 2, 1, 1, 'IAN', 'CARLOS', 'LEIVA', 'BARRIOS', NULL, '10-07-1970');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6816462731314', 1, 2, 2, 'PAULINA', NULL, 'BURGOS', 'CASTELLANOS', 'ASTURIAS', '09-25-1996');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '9271936121229', 2, 2, 2, 'VICTORIA', 'MARIANELA', 'MORALES', 'LINARES', NULL, '06-24-1999');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '6078860591201', 1, 2, 2, 'SONIA', 'CARMELIA', 'ALVAREZ', 'CORONADO', 'ESTRADA', '06-28-1963');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '7815031191412', 1, 1, 3, 'JOSE', 'LEANDRO', 'BAMACA', 'MORALES', NULL, '03-22-1972');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '3976215311413', 1, 2, 2, 'NATALY', 'GUADALUPE', 'CASTILLO', 'MONTERROSO', 'MORALES', '01-17-1987');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '5466238372011', 2, 1, 1, 'JUAN', 'SEBASTIAN', 'PRADO', 'MORALES', NULL, '06-13-1973');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
...
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
values (SQC_PERSONA.Nextval, '5241332192001', 1, 2, 2, 'ANA', 'JIMENA', 'ENRIQUEZ', 'CASTILLA', NULL, '03-19-2003');
insert into PERSONA (COD_PERSONA, NO_IDENTIFICACION, COD_IDENTIFICACION, COD_SEXO, COD_GENERO, NOMBRE_1, NOMBRE_2, APELLIDO_2, APELLIDO_CASADA, FECHA_NACIMIENTO) 
